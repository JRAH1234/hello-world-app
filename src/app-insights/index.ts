...
import { AppInsightsConfig, AppInsightsService } from './app-insight.service';

export { SeverityLevel, AppInsightsConfig, AppInsightsService } from './app-insight.service';
